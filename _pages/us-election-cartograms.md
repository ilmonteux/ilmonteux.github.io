...
The cartograms here are based on the Gastner-Newman algorithm  [(link to paper)](www.pnas.org/content/101/20/7499), in particular using the C++ implementation provided by one of the authors at [http://www-personal.umich.edu/~mejn/cart](http://www-personal.umich.edu/~mejn/cart).
