...
```
This results in an [interactive webpage](https://github.com/ilmonteux/mapping/tree/master/chronomaps/figs/travel_map_Irvine.html) with OpenStreetMap background and a filled contour shading (also seen here in an iframe):

<iframe src="https://github.com/ilmonteux/mapping/tree/master/chronomaps/figs/travel_map_Irvine.html" style="width: 49%; height: 300px"></iframe>
